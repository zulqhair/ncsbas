    ...
    @else
        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-5"><section class="card h-100" aria-labelledby="status-heading"><div class="card-body">
                ...
                <div class="chart-container chart-container-sm" data-chart-container hidden><div id="assessmentStatusChart" role="img" aria-label="Assessment status chart."></div></div>
            </div></section></div>
            <div class="col-lg-7"><section class="card h-100" aria-labelledby="maturity-heading"><div class="card-body">
                ...
                <div class="chart-container chart-container-sm" data-chart-container hidden><div id="maturityChart" role="img" aria-label="Maturity distribution chart."></div></div>
            </div></section></div>
        </div>
        <section class="card mb-4" aria-labelledby="scores-heading"><div class="card-body">
            ...
            <div class="chart-container" data-chart-container hidden><div id="assessmentScoresChart" role="img" aria-label="Assessment score chart."></div></div>
        </div></section>
        <section class="card" aria-labelledby="elements-heading"><div class="card-body">
            ...
            <div class="chart-container chart-container-lg" data-chart-container hidden><div id="elementPerformanceChart" role="img" aria-label="Element performance chart."></div></div>
        </div></section>
    @endif
