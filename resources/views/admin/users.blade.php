...
@section('content')
    <div class="page-heading"><div><p class="eyebrow">Administration</p><h1>User management</h1><p>Assign Assessor, Reviewer, or Admin access.</p></div><a class="btn btn-outline-primary" href="{{ route('dashboard') }}"><x-icon name="back" /> Dashboard</a></div>
